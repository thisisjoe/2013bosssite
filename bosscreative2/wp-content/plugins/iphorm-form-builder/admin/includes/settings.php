    ...
    <form method="post" action="">
        ...
        <table class="form-table iphorm-purchase-settings">
            ...
            <tr>
                ...
                <td><div class="iphorm-verify-purchase-code-wrap clearfix"><input id="purchase_code" type="text" name="purchase_code" class="iphorm-recaptcha-key-input" value="" /> <button class="ifb-button" id="verify-purchase-code"><?php esc_html_e('Verify', 'iphorm'); ?></button> <span class="iphorm-verify-loading"></span> </div></td>
            </tr>
        </table>
    </form>
    <form method="post" action="">
        ...
        disable both the CSS and JavaScript for the script.', 'iphorm'); ?></p>
